...
public class PrintAnnotationExample {
	...
	public static void main(String[] args) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
		...
		//클래스 정보얻기 방법 1
		//클래스 자체에서 클래스 정보(메소드 맴버 정보) 얻기
		//메소드1 메소드2 메소드3 순서 아님. 순서, 중복이 없는 메소드배열
		Method[] declaredMethods = Service.class.getDeclaredMethods();
		
		//클래스 정보얻기 방법 2
		//클래스 객체생성해서 메소드 맴버 정보 얻기
		//Service myService = new Service();
		//Method[] declaredMethods2 = myService.getClass().getDeclaredMethods();
		...
		for(Method method : declaredMethods) {
			...
			//메소드 자체 실행문 실행, Service 클래스의 메소드는 Service 객체가 필요하므로 매개값으로 Service 객체 생성해서 넣어줌
